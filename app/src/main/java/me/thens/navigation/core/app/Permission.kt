...
sealed class Permission(
    ...
    fun register(activity: ComponentActivity, onResult: (Boolean) -> Unit = {}) =
        PermissionRegistry(this, activity, onResult)
    ...
    object STORAGE: Permission("STORAGE", Manifest.permission.READ_EXTERNAL_STORAGE)
}

@OptIn(ExperimentalPermissionsApi::class)
@Composable
private fun PermissionAlert(name: String, permissionsState: MultiplePermissionsState) {
    AlertDialog(
